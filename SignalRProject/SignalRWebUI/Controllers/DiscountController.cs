...
namespace SignalRWebUI.Controllers
{
	public class DiscountController : Controller
	{
        ...
        {
            var client = _httpClientFactory.CreateClient();
            await client.GetAsync($"https://localhost:7172/api/Discount/ChangeStatusToTrue/{id}");
			return RedirectToAction("Index");
        }
        ...
        {
            var client = _httpClientFactory.CreateClient();
            await client.GetAsync($"https://localhost:7172/api/Discount/ChangeStatusToFalse/{id}");
			return RedirectToAction("Index");
		}
	}
}
